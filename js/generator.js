...
document.addEventListener('DOMContentLoaded', () => {
  ...
  <p align="left">\n${linkedin ? `<a href="https://linkedin.com/in/${linkedin}" target="blank"><img align="center" src="src/images/icons/Social/linked-in-alt.svg" alt="${linkedin}" height="30" width="40" /></a>&nbsp;&nbsp;` : ''}${twitter ? `<a href="https://twitter.com/${twitter}" target="blank"><img align="center" src="src/images/icons/Social/twitter.svg" alt="${twitter}" height="30" width="40" /></a>&nbsp;&nbsp;` : ''}${facebook ? `<a href="https://fb.com/${facebook}" target="blank"><img align="center" src="src/images/icons/Social/facebook.svg" alt="${facebook}" height="30" width="40" /></a>&nbsp;&nbsp;` : ''}${instagram ? `<a href="https://instagram.com/${instagram}" target="blank"><img align="center" src="src/images/icons/Social/instagram.svg" alt="${instagram}" height="30" width="40" /></a>&nbsp;&nbsp;` : ''}${dev ? `<a href="https://dev.to/${dev}" target="blank"><img align="center" src="src/images/icons/Social/devto.svg" alt="${dev}" height="30" width="40" /></a>&nbsp;&nbsp;` : ''}${medium ? `<a href="https://medium.com/@${medium}" target="blank"><img align="center" src="src/images/icons/Social/medium.svg" alt="${medium}" height="30" width="40" /></a>&nbsp;&nbsp;` : ''}${stackoverflow ? `<a href="https://stackoverflow.com/users/${stackoverflow}" target="blank"><img align="center" src="src/images/icons/Social/stack-overflow.svg" alt="${stackoverflow}" height="30" width="40" /></a>&nbsp;&nbsp;` : ''}${codepen ? `<a href="https://codepen.io/${codepen}" target="blank"><img align="center" src="src/images/icons/Social/codepen.svg" alt="${codepen}" height="30" width="40" /></a>` : ''}
    ...
    function generateTechStackIcons(technologies) {
      const techIcons = {
        // Programming Languages
        javascript: 'images/icons/devicons/javascript/javascript-original.svg',
        typescript: 'images/icons/devicons/typescript/typescript-original.svg',
        python: 'images/icons/devicons/python/python-original.svg',
        java: 'images/icons/devicons/java/java-original.svg',
        c: 'images/icons/devicons/c/c-original.svg',
        cpp: 'images/icons/devicons/cplusplus/cplusplus-original.svg',
        csharp: 'images/icons/devicons/csharp/csharp-original.svg',
        php: 'images/icons/devicons/php/php-original.svg',
        ruby: 'images/icons/devicons/ruby/ruby-original.svg',
        swift: 'images/icons/devicons/swift/swift-original.svg',
        go: 'images/icons/devicons/go/go-original.svg',
        rust: 'images/icons/devicons/rust/rust-plain.svg',

        // Frontend
        html5: 'images/icons/devicons/html5/html5-original-wordmark.svg',
        css3: 'images/icons/devicons/css3/css3-original-wordmark.svg',
        react: 'images/icons/devicons/react/react-original-wordmark.svg',
        angular: 'images/icons/devicons/angular/angular.svg',
        vue: 'images/icons/devicons/vuejs/vuejs-original-wordmark.svg',
        bootstrap: 'images/icons/devicons/bootstrap/bootstrap-plain-wordmark.svg',
        tailwind: 'images/icons/devicons/tailwindcss/tailwindcss-icon.svg',
        sass: 'images/icons/devicons/sass/sass-original.svg',

        // Backend
        nodejs: 'images/icons/devicons/nodejs/nodejs-original-wordmark.svg',
        express: 'images/icons/devicons/express/express-original-wordmark.svg',
        django: 'images/icons/devicons/django/django.svg',
        spring: 'images/icons/devicons/springio/springio-icon.svg',
        flask: 'images/icons/devicons/pocoo_flask/pocoo_flask-icon.svg',
        laravel: 'images/icons/devicons/laravel/laravel-plain-wordmark.svg',
        graphql: 'images/icons/devicons/graphql/graphql-icon.svg',

        // Database
        mongodb: 'images/icons/devicons/mongodb/mongodb-original-wordmark.svg',
        mysql: 'images/icons/devicons/mysql/mysql-original-wordmark.svg',
        postgresql: 'images/icons/devicons/postgresql/postgresql-original-wordmark.svg',
        redis: 'images/icons/devicons/redis/redis-original-wordmark.svg',
        sqlite: 'images/icons/devicons/sqlite/sqlite-icon.svg',
        oracle: 'images/icons/devicons/oracle/oracle-original.svg',

        // DevOps
        aws: 'images/icons/devicons/amazonwebservices/amazonwebservices-original-wordmark.svg',
        docker: 'images/icons/devicons/docker/docker-original-wordmark.svg',
        kubernetes: 'images/icons/devicons/kubernetes/kubernetes-icon.svg',
        gcp: 'images/icons/devicons/google_cloud/google_cloud-icon.svg',
        azure: 'images/icons/devicons/microsoft_azure/microsoft_azure-icon.svg',
        jenkins: 'images/icons/devicons/jenkins/jenkins-icon.svg',
        git: 'images/icons/devicons/git-scm/git-scm-icon.svg',

        // Mobile
        android: 'images/icons/devicons/android/android-original-wordmark.svg',
        ios: 'images/icons/devicons/apple/apple-original.svg',
        flutter: 'images/icons/devicons/flutterio/flutterio-icon.svg',
        reactnative: 'images/icons/devicons/reactnative/header_logo.svg',
        kotlin: 'images/icons/devicons/kotlinlang/kotlinlang-icon.svg',
      };
